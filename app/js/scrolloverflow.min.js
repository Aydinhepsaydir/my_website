            ...
            null != h
              ...
              : ((i = t.scrollHeight - a),
                s.options.verticalCentered &&
                  (i = f(l, t)[0].scrollHeight - a));
            var c = fp_utils.getWindowHeight() - a;
            i > c
              ? null != h
                ? e.update(t, c)
                : (s.options.verticalCentered
                    ? (fp_utils.wrapInner(f(l, t)[0], o.scroller),
                      fp_utils.wrapInner(f(l, t)[0], o.scrollable))
                    : (fp_utils.wrapInner(t, o.scroller),
                      fp_utils.wrapInner(t, o.scrollable)),
                  e.create(t, c, s.iscrollOptions))
              : e.remove(t),
        ...
        m = {
          ...
          init: function(i) {
            ...
            return (
              ...
              (m.iscrollOptions = fp_utils.deepExtend(
                m.iscrollOptions,
                i.scrollOverflowOptions
              )),
              new u().init(i, m.iscrollOptions)
            );
          },
          ...
          create: function(t, i, s) {
            f(e, t).forEach(function(e) {
              ...
              null != o &&
                ...
                (o = new IScroll(e, s)),
                m.iScrollInstances.push(o),
                fp_utils.hasClass(fp_utils.closest(t, n), "active") ||
                  o.wheelOff(),
                (e.fp_iscrollInstance = o);
            });
          },
          isScrolled: function(t, i) {
            ...
            return (
              !s ||
              ("top" === t
                ? s.y >= 0 && !fp_utils.getScrollTop(i)
                : "bottom" === t
                ? 0 - s.y + fp_utils.getScrollTop(i) + 1 + i.offsetHeight >=
                  i.scrollHeight
                : void 0)
            );
          },
            ...
            if (null != t) {
              ...
              if (null != i) {
                ...
                null != s && s.destroy(),
                  ...
                  (f(".fp-scroller", t)[0].outerHTML = f(
                    ".fp-scroller",
                    t
                  )[0].innerHTML),
                  (f(e, t)[0].outerHTML = f(e, t)[0].innerHTML);
              }
            }
          },
          update: function(t, i) {
            clearTimeout(m.refreshId),
              (m.refreshId = setTimeout(function() {
                m.iScrollInstances.forEach(function(t) {
                  t.refresh(),
                    fullpage_api.silentMoveTo(fp_utils.index(f(r)[0]) + 1);
                });
              }, 150)),
              fp_utils.css(f(e, t)[0], { height: i + "px" });
          ...
          wrapContent: function() {
            ...
            return (
              (e.className = "fp-scroller"), { scrollable: t, scroller: e }
            );
          }
        };
